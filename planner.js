...
const App = () => {
    ...
    const renderPhase = (phase, index) => {
        ...
        return (
            <div key={phase.id} className={`relative pl-14 pb-12 ${index === PHASES_DATA.length - 1 ? 'last-phase' : ''}`}>
                {/* Connector Line */}
                ...
                {/* Phase Icon Bubble */}
                <div className={`absolute left-0 top-0 w-12 h-12 rounded-full flex items-center justify-center border-4 z-10 
                ...
                {/* Card Content */}
                <div className={`rounded-xl p-6 shadow-sm border transition-all duration-300 backdrop-blur-md
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                        <div>
                            <h3 className={`text-xl font-bold ${isLate ? 'text-red-700' : 'text-gray-900'}`}>{phase.title}</h3>
                                ...
                                <div className="flex flex-col items-end">
                                    ...
                                    <div className="flex gap-1">
                                        ...
                                        <button 
                                            ...
                                            className={`px-3 py-1 rounded-r-md text-xs font-medium border transition-colors
                                            ${isFinishPaid
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm flex flex-col justify-center items-center h-full text-center group hover:border-indigo-200 transition-colors cursor-pointer">
                            ...
                            {isActive || isCompleted || isBuffer || isLate ? (
                                <a href={phase.demoLink} target="_blank" className="flex flex-col items-center text-indigo-600 hover:text-indigo-800">
                                    <ExternalLink size={24} className="mb-2 group-hover:scale-110 transition-transform"/>
    ...
    return (
        <div className="min-h-screen pb-24 font-sans bg-gray-100 text-gray-900">
            {/* Top Hero / Header */}
            <div className="bg-indigo-900 text-white pt-12 pb-24 px-4 shadow-xl">
